...
import com.mindtree.utility.TakeScreenShots;
...
public class ExtentReportsClass {
	...
	public ExtentReportsClass(WebDriver driver) throws IOException {
		...
		extent = new ExtentReports(
				System.getProperty("user.dir")+read.getExtentReportPath() + TakeScreenShots.getCurrentDateTime() + ".html");
	}

	public void start(String name) throws IOException {

		logger = extent.startTest(name);
		logger.log(LogStatus.PASS, logger.addScreenCapture(TakeScreenShots.captureScreenshot(driver)) + "Test Passed " + name);
